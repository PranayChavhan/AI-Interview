    ...
    <AnimatePresence>
      <div className="min-h-[100vh] sm:min-h-screen w-screen flex flex-col relative bg-[#F2F3F5] font-inter overflow-hidden">
        ...
        <main className="flex flex-col justify-center h-[90%] static md:fixed w-screen overflow-hidden grid-rows-[1fr_repeat(3,auto)_1fr] z-[100] pt-[30px] pb-[320px] px-4 md:px-20 md:py-0">
          ...
          >
            <path
              d="M 1.347656 0 L 278.660156 0 L 278.660156 43.003906 L 1.347656 43.003906 Z M 1.347656 0 "
              fill="#1E2B3A"
            />
          </motion.svg>
          ...
          >
            ...
            <div className="w-1/2">
              ...
              <p className="text-[14px] leading-[20px] text-[#1a2b3b] font-normal">
                Join a community of like-minded individuals, learn from each
        ...
        ></motion.canvas>
       <div className="h-[60px] bg-[#1D2B3A] fixed bottom-0 z-20 w-full flex flex-row items-center px-8">
          <p className="text-gray-300 font-medium text-xl">
            Prototype Developed for Innerve 8.0 (AIT, Pune) <span className="text-gray-300">By Team Binary Brigade (PICT, Pune)</span>
          </p>
       </div>
      </div>
    </AnimatePresence>
